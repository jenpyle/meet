# Meet App
[Serverless](#serverless-and-api), progressive web application [(PWA)](#progressive-web-application) with React using a test-driven development [(TDD)](#testing) technique. The application uses the Google Calendar API to fetch upcoming event. See the [Detailed Project Description](#detailed-project-description) section for more information
